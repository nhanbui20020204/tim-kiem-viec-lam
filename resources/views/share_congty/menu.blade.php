    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-dark navbar-shadow menu-border container-xxl"
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    {{-- Công Ty --}}
                @if(Auth::guard('congty')->check() == true)
                    <li class="dropdown nav-item"><a class=" nav-link d-flex align-items-center"
                            href="/cong-ty/tieu-chi"><i data-feather="package"></i><span data-i18n="Apps">Tiêu
                                Chí</span></a>
                    </li>
                    <li class="dropdown nav-item"><a class=" nav-link d-flex align-items-center" href="/lienhe"><i
                                data-feather="package"></i><span data-i18n="Apps">Liên Hệ Phỏng Vấn</span></a>
                    </li>
                @endif
            </ul>
        </div>
