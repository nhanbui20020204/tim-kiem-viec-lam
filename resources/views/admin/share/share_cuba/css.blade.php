<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="/assets_admin/css/vendors/themify.css">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="/assets_admin/css/vendors/flag-icon.css">
    <!-- Feather icon-->
    <link rel="stylesheet" type="text/css" href="/assets_admin/css/vendors/feather-icon.css">
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="/assets_admin/css/vendors/scrollbar.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="/assets_admin/css/vendors/bootstrap.css">
    <!-- App css-->
