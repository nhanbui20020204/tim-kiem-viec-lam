...
<div class="header-logo-wrapper col-auto p-0">
    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="/assets_admin/images/logo/logo.png"
                alt=""></a></div>
                        ...
                        <div class="col mega-box">
                            <div class="link-section">
                                ...
                                <ul class="svg-icon">
                                    ...
                                    <li><a href="comingsoon-bg-video.html"> <i data-feather="film"> </i>Coming-video</a>
                                    </li>
                                    <li><a href="comingsoon-bg-img.html"><i data-feather="image"> </i>Coming-Image</a>
                                    </li>
                                </ul>
                                <div>
                                    <h6>Other Soon</h6>
    ...
    <ul class="nav-menus">
      ...
      <li class="cart-nav onhover-dropdown">
        ...
        <ul class="cart-dropdown onhover-show-div">
          ...
          <li class="mt-0">
            <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="/assets_admin/images/ecommerce/01.jpg" alt="">
          ...
          <li class="mt-0">
            <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="/assets_admin/images/ecommerce/03.jpg" alt="">
              <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                <p>Yellow(#fcb102)</p>
                <div class="qty-box">
                  <div class="input-group"><span class="input-group-prepend">
      ...
      <li class="onhover-dropdown"><i data-feather="message-square"></i>
        <ul class="chat-dropdown onhover-show-div">
          ...
          <li>
            <div class="media"><img class="img-fluid rounded-circle me-3" src="/assets_admin/images/user/1.jpg" alt="">
          ...
          <li>
            <div class="media"><img class="img-fluid rounded-circle me-3" src="/assets_admin/images/user/2.jpg" alt="">
              <div class="status-circle online"></div>
          ...
          <li>
            <div class="media"><img class="img-fluid rounded-circle me-3" src="/assets_admin/images/user/4.jpg" alt="">
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
            <div class="media profile-media"><img class="b-r-10" src="/assets_admin/images/dashboard/profile.jpg"
                    alt="">
                <div class="media-body"><span>Admin</span>
                    <p class="mb-0 font-roboto">Settings <i class="middle fa fa-angle-down"></i></p>
                </div>
            </div>
