                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="mb-2">
                                        <label>Khoa</label>
                                        <select v-model="add.id_khoa" class="form-select">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle text-nowrap">
                                            <button v-on:click="changeStatus(value)" v-if="value.is_active == 0"
                                                class="btn btn-warning">Chưa kích hoạt</button>
                                            <button v-on:click="changeStatus(value)" v-else-if="value.is_active == -1"
                                                class="btn btn-danger">Bị khoá</button>
                                            <button v-on:click="changeStatus(value)" v-else class="btn btn-success">Hoạt
                                                động</button>
                                        </td>
                                        <td class="text-center align-middle text-nowrap">
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Đóng</button>
                                        <button v-on:click="updateSinhVien()" type="button" class="btn btn-primary"
    ...
    <script>
        new Vue({
            ...
            methods: {
                doiMatKhau() {
                    axios
                        .post('{{ Route('doiMatKhau') }}', this.newpass)
                        .then((res) => {
                            if (res.data.status) {
                ...
                timKiem() {
                    ...
                    axios
                        .post('{{ Route('searchSinhvien') }}', payload)
                        .then((res) => {
                ...
                updateSinhVien() {
                    if (!this.validateEmail(this.edit.email)) {
                        ...
                        axios
                        .post('{{ Route('updateSinhvien') }}', this.edit)
                        .then((res) => {
                            if (res.data.status) {
                ...
                changeStatus(value) {
                    axios
                        .post('{{ Route('statusSinhvien') }}', value)
                        .then((res) => {
                            if (res.data.status) {
                                this.loadData();
                                toastr.success(res.data.message);
                ...
                xoaSinhVien() {
                    axios
                        .post('{{ Route('deleteSinhvien') }}', this.del)
                        .then((res) => {
                            if (res.data.status) {
                                this.timKiem();
                                toastr.success(res.data.message);
                ...
                themMoi() {
                    if (!this.validateEmail(this.add.email)) {
                        ...
                        axios
                        .post('{{ Route('createSinhvien') }}', this.add)
                        .then((res) => {
                            if (res.data.status) {
                                toastr.success(res.data.message);
                                this.add = {};
